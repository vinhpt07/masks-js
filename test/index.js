...
const testSamples = [
  { input: null, expectedResult: 'nothing', description: 'should return null when null is passed' },
  { input: undefined, expectedResult: 'nothing', description: 'should return null when undefined is passed' },
